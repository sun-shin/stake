User.create!([
  ...
  {email: "sun@gmail.com", password_digest: "$2a$12$tWHCdrNusyh0Mvoe2uM7sOJ93S7Zqd6LGOxW18FP17YityyMLK1ly", image: "https://res.cloudinary.com/dgzqmcw5b/image/upload/v1605896159/qdzmqovzduy8rdgy8fg4.jpg", phone_number: "8159633690", first_name: "Moon", last_name: "Shin"}
])
Tag.create!([
  {name: "Animals"},
  {name: "Arts & Culture"},
...
Event.create!([
  {title: "Chicago Marathon", user_id: 1, description: "Help with runner registration, passing out hot beverages, and clean-up at the end of the event.", address: "337 E Randolph St", attendee_limit: 50, event_start: "2020-12-08 10:00:00", duration: 6},
  {title: "Basketball Tournament Help", user_id: 1, description: "Help with player and team registration. Duties include refereeing, cleaning, and guiding players and teams to the right courts.", address: "737 S Halsted St", attendee_limit: 20, event_start: "2020-11-28 14:00:00", duration: 6},
  {title: "Chicago Dogs and Cats", user_id: 7, description: "PET LOVERS ONLY!!!! We are looking for volunteers to help our furry friends to find warm homes for the upcoming holiday season. You will be helping clean, feed, and playing with the animals!", address: "1997 N Clybourn Ave", attendee_limit: 10, event_start: "2020-11-30 17:00:00", duration: 5},
  {title: "Bridgeport Food Bank Help", user_id: 8, description: "We will be organizing donations into the pantry within the facility. Also will be handing out and delivering food to those in need.", address: "10 S Riverside Plaza", attendee_limit: 15, event_start: "2020-11-25 16:00:00", duration: 7},
  {title: "Light-Up Pilsen", user_id: 10, description: "Help our community hang up lights and decorations on 18th Street for the Holiday season!", address: "1805 S Loomis St", attendee_limit: 50, event_start: "2020-12-01 14:30:00", duration: 7},
  {title: "Lakefront Clean-up", user_id: 2, description: "Come help pick up loose trash on beaches and lakefront trail keeping our city clean!", address: "5800 N. Sheridan Rd", attendee_limit: 100, event_start: "2020-12-15 16:00:00", duration: 10},
  {title: "Fall Festival - Uptown", user_id: 2, description: "fall festivities", address: "4701 N Ashland Ave", attendee_limit: 2, event_start: "2020-10-06 13:27:00", duration: 100},
  {title: "Flu-Shot Aid", user_id: 2, description: "Help providers while they distribute flu-shots to patients.", address: "1740 W Taylor St", attendee_limit: 4, event_start: "2020-12-17 14:00:00", duration: 10},
  {title: "Farmers Market Help", user_id: 1, description: "help vendors set-up ", address: "W Adams St & S Dearborn St", attendee_limit: 1, event_start: "2020-11-13 15:45:00", duration: 100},
  {title: "Coding Help", user_id: 1, description: "Im stuck and someone is not doing their job", address: "215 W Ohio St", attendee_limit: 1, event_start: "2020-11-21 18:18:00", duration: 8}
])
EventUser.create!([
  ...
  {user_id: 10, event_id: 5},
  {user_id: 10, event_id: 7},
  {user_id: 11, event_id: 6},
  {user_id: 11, event_id: 5},
  {user_id: 11, event_id: 7},
  {user_id: 12, event_id: 6},
  {user_id: 12, event_id: 5},
  ...
  {user_id: 1, event_id: 11}
])
EventTag.create!([
  {event_id: 3, tag_id: 12},
  {event_id: 3, tag_id: 15},
  {event_id: 4, tag_id: 15},
  {event_id: 4, tag_id: 14},
  {event_id: 4, tag_id: 12},
  {event_id: 5, tag_id: 1},
  {event_id: 6, tag_id: 3},
  {event_id: 6, tag_id: 10},
  {event_id: 6, tag_id: 9},
  {event_id: 6, tag_id: 15},
  {event_id: 7, tag_id: 2},
  {event_id: 7, tag_id: 15},
  {event_id: 1, tag_id: 7},
  {event_id: 1, tag_id: 8},
  {event_id: 1, tag_id: 15},
  {event_id: 8, tag_id: 15},
  {event_id: 8, tag_id: 14},
  {event_id: 8, tag_id: 11},
  {event_id: 2, tag_id: 8},
  {event_id: 2, tag_id: 11},
  {event_id: 2, tag_id: 14},
  {event_id: 9, tag_id: 6},
  {event_id: 10, tag_id: 2},
  {event_id: 10, tag_id: 15},
  {event_id: 11, tag_id: 6}
])
